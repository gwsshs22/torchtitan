...
class WandBLogger(BaseLogger):
    ...
    def __init__(self, log_dir: str, job_config: JobConfig, tag: str | None = None):
        ...
        self.wandb.init(
            ...
            project=metrics_config.wandb_project or os.getenv("WANDB_PROJECT", "torchtitan"),
            name=metrics_config.wandb_run_name or os.getenv("WANDB_RUN_NAME", None),
...
class MetricsProcessor:
    ...
    def log(
        ...
        logger.info(
            ...
            f"{color.green}loss: {global_avg_loss:7.6f}  "
            f"{color.orange}grad_norm: {grad_norm:7.6f}  "
